...
// GetByID ....
func (s *service) GetByID(ctx context.Context, id int) (models.Producto, error) {
...
// Update ...
func (s *service) Update(ctx context.Context, producto models.Producto, id int) (models.Producto, error) {
